...
![Trace Type](assets/types-of-trace.png)
...
2. Go to Desktop > Window > Properties
3. Add parameters in the Parameters tab:
...
1. Right click in the Plot Area.
2. Select **Trace Limits**.
3. Edit Low and High values.

!!! note
    Trace Limits do not affect Logical traces.
