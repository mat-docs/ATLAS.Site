...
# ATLAS Viewer Release: v11.5.1.XXX
...
### SQLRace Parameter Resolution Without AppName
Fixed an issue where SQLRace failed to resolve parameters when `appName` was not specified.
