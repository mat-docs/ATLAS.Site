...
### Getting Started
- **[Main Overview](reference_docs/index.md)** - Introduction, architecture, and quick start guide
...
**Create and manage sessions**
→ See [Session Manager Module](reference_docs/session-manager.md)

**Define data formats for my parameters**
→ See [Data Format Manager Module](reference_docs/data-format-manager.md)

**Write telemetry data to Kafka**
→ See [Writer Module](reference_docs/writer-module.md)
...
→ See [Interpolation Module](reference_docs/interpolation-module.md)

**Find specific API details**
→ See [API Reference](reference_docs/api-reference.md)

## Architecture Overview

![Architecture Diagram](reference_docs/images/architecture-diagram.svg)
