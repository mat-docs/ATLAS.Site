...
The [Toolkit Services](../services/index.md) provide implementations of the API, in either a [single-process](../../../key-functionality/integrate/rta/introduction/architectures.md#rta-server) or [microservices](../../../key-functionality/integrate/rta/introduction/architectures.md#microservices) architecture.
