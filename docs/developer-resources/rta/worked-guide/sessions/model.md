...
:   Binds one or more sets of [Configuration](../configuration/index.md) onto a session.
    ...
    :   Tells the client to apply an offset to every channel in the configuration descriptor (&gt;= 0).
        ...
        This is done so that sessions can contain configuration from multiple independently-compiled "apps", and shared across sessions. This turns out to be important for [scalability](../../../../key-functionality/integrate/rta/introduction/configuration.md#designed-for-scale) when sessions have 10s of thousands of parameters.
