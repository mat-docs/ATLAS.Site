...
For .NET, library support is provided via Motion Applied's [NuGet packages](../../downloads.md#nuget-packages).
...
It is supported in C#, F#, C++ VB.NET for .NET Core and .NET Framework, via Motion Applied's [NuGet packages](../../downloads.md#nuget-packages).  
