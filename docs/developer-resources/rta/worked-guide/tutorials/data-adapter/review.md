...
This service is based on the **ASP.NET Core Web Application** template in Visual Studio 2019, using the McLaren _MAT.OCS.RTA.Services.AspNetCore_ [NuGet Package](../../../downloads.md#nuget-packages) to provide common functionality. This library is also used in all the [Toolkit Services](../../../services/index.md).
...
Writing Data Adapter services in C# and ASP.NET Core shortens development using the RTA [NuGet packages](../../../downloads.md#nuget-packages) &mdash; and even without this advantage, ASP.NET Core is a mature, powerful, cross-platform framework, with a rich ecosystem.
